...
var rchi = require( '@stdlib/random-base-chi' ).factory;
...
tape( 'the function throws an error if degrees of freedom `k` is not a positive number', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns an iterator for generating pseudorandom numbers from a chi distribution', function test( t ) {
	var rand;
	var it;
	var i;
